...
<div class="sidebar-section">
	...
	<ul class="section-links">
		<li class="swatch-6" data-href="/account/repositories" use:active>
			<a href="/account/repositories" use:active>
		...
		<li class="swatch-7" data-href="/account/tokens" use:active>
		...
		<li class="swatch-8" data-href="/account/settings" use:active>
